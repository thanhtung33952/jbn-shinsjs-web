...
class Acoordion10 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      expanded: false,
        ...
        >
          ...
          >
            <Typography className={classes.headingAcoordion}>
              {/* {this.findValitionAcoordion("acoordion10") ? (
            ...
            <Button
              ...
              href={`${folderRoot}construction-plan/${dataDetail.id}`}
              target="_blank"
              variant="outlined"
...
export default connect(mapStateToProps)(
  withRoot(withStyles(styles)(Acoordion10))
);
