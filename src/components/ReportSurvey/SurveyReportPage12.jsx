...
// component custommer
import FormReport13 from "components/ReportSurvey/FormReport13.jsx";
...
class SurveyReportPage12 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  componentDidMount = () => {
    this.props.updateStatusPage(
      this.props.numberNoStart === 1 ? "page131" : "page132"
    );
  };
  render = () => {
...
SurveyReportPage12.propTypes = {
  classes: PropTypes.object.isRequired,
  id: PropTypes.string,
  numberNoStart: PropTypes.number,
  updateStatusPage: PropTypes.func
};
export default withRoot(withStyles(styles)(SurveyReportPage12));
