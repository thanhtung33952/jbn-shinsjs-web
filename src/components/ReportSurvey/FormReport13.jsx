...
class FormRecord13 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      scroolLeft: 0,
      ...
      arrayRenderData.map((item, i) => {
        ...
        let conversion_N_value =
          surveyInfo[0] && surveyInfo[0][`${item}`]
            ? surveyInfo[0][`${item}`].conversion_N_value
            : "";
          ...
          return (
            <tr key={i}>
              ...
              <td className={classes.bgLuoi}>
                ...
                <hr />
                <span
                  style={{ width: `${parseFloat(conversion_N_value * 5)}%` }}
                ></span>
              </td>
            </tr>
          );
      ...
      arrayRenderData.map((item, i) => {
        ...
        let conversion_N_value =
          surveyInfo[1] && surveyInfo[1][`${item}`]
            ? surveyInfo[1][`${item}`].conversion_N_value
            : "";
      ...
      arrayRenderData.map((item, i) => {
        ...
        let conversion_N_value =
          surveyInfo[2] && surveyInfo[2][`${item}`]
            ? surveyInfo[2][`${item}`].conversion_N_value
            : "";
      ...
      arrayRenderData.map((item, i) => {
        ...
        let conversion_N_value =
          surveyInfo[3] && surveyInfo[3][`${item}`]
            ? surveyInfo[3][`${item}`].conversion_N_value
            : "";
      ...
      arrayRenderData.map((item, i) => {
        ...
        let conversion_N_value =
          surveyInfo[4] && surveyInfo[4][`${item}`]
            ? surveyInfo[4][`${item}`].conversion_N_value
            : "";
...
FormRecord13.propTypes = {
  classes: PropTypes.object.isRequired,
  surveyId: PropTypes.string,
  numberNoStart: PropTypes.number
};
export default withRoot(withStyles(styles)(FormRecord13));
