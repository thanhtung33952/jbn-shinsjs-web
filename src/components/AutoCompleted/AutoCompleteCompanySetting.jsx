    ...
    return (
      <React.Fragment>
        ...
        {permission === "R" ? (
          ...
          <div className={classes.root} style={{ zIndex: zIndex }}>
            <Downshift
                    ...
                    <div {...getMenuProps()}>
                      {isOpen ? (
                        <Paper className={classes.paper} square>
                          <IconButton
                            component="span"
                            className={classes.closeDownsift}
                            onClick={closeDownShift}
                          >
                            <CloseIcon />
                          </IconButton>
...
AutoComplete.propTypes = {
  ...
  isOpenDownShift: PropTypes.bool,
